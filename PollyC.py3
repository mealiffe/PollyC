#!/usr/bin/python3
# vim: ft=python
# PollyC.py3 version 0.10.0
# This module is used to call the Amazon Polly system to convert an incomming string
# to a audio file.
# Calling sequence
#   ./scripts/PollyC.py3 -o "output_file" -t "the text to speak" -c "./pollycache/" -k "key_ID" -a Key"
#
# arguments
#
...
#
    ...
    hashtext = ''.join(c for c in unicodedata.normalize('NFD', hashtext) if unicodedata.category(c) != 'Mn')
